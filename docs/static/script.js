...
const translations = {
    fr: {
        "banner.text": "Un outil PixoGlace, libre et soigneusement emballe.",
        ...
        "hero.kicker": "PDF · Etiquettes · Impression",
        "hero.title": "Imprimez vos bordereaux<br><em>sans friction.</em>",
        "hero.copy": "PixoCrop detecte la zone utile d'un PDF, la recadre proprement et l'envoie a l'imprimante avec un apercu clair.",
        "hero.bubbleOpen": "Open source",
        "hero.bubbleClear": "Recadrage clair",
        "hero.bubblePrint": "Pret a imprimer",
        "hero.scroll": "Voir l'outil",
        "features.kicker": "Le flux de travail",
        "features.title": "Un petit outil pour gagner <em>beaucoup de gestes.</em>",
        "features.autoTitle": "Detection automatique",
        ...
        "features.manualCopy": "Dessinez ou deplacez la zone si le document a un format particulier.",
        ...
        "features.releaseTitle": "Releases natives",
        "features.releaseCopy": "Generez des installateurs Windows, des DMG macOS et des paquets Linux avec les cibles de release.",
        ...
        "install.kicker": "Installer et publier",
        "install.title": "Un depot pret pour GitHub Pages et les releases.",
        "install.copy": "La vitrine vit dans <code>docs/</code>. Dans GitHub, activez Pages depuis la branche principale avec le dossier <code>/docs</code>.",
        "install.releases": "Releases",
        "install.source": "Code source",
        "download.kicker": "Binaires prets a lancer",
        "download.title": "Telechargez PixoCrop pour <em>votre plateforme.</em>",
        "download.loading": "Recherche de la derniere version...",
        "download.ready": "Derniere version disponible : <strong>{version}</strong>",
        "download.failed": "Impossible de charger la derniere release. Les liens ouvrent GitHub.",
    ...
    en: {
        ...
        "features.releaseTitle": "Native releases",
        "features.releaseCopy": "Generate Windows installers, macOS DMGs and Linux packages with the release targets.",
        ...
        "install.kicker": "Install and publish",
        "install.title": "A repository ready for GitHub Pages and releases.",
        "install.copy": "The website lives in <code>docs/</code>. In GitHub, enable Pages from the main branch with the <code>/docs</code> folder.",
        "install.releases": "Releases",
    ...
    ar: {
        ...
        "features.releaseTitle": "إصدارات أصلية",
        "features.releaseCopy": "أنشئ مثبتات Windows وملفات DMG لـ macOS وحزم Linux من أهداف الإصدار.",
        ...
        "install.kicker": "التثبيت والنشر",
        "install.title": "مستودع جاهز لـ GitHub Pages والإصدارات.",
        "install.copy": "الموقع موجود في <code>docs/</code>. في GitHub فعّل Pages من الفرع الرئيسي مع مجلد <code>/docs</code>.",
    ...
    zh: {
        ...
        "features.releaseTitle": "原生发布包",
        "features.releaseCopy": "通过 release 目标生成 Windows 安装器、macOS DMG 和 Linux 包。",
        ...
        "install.kicker": "安装与发布",
        "install.title": "已准备好 GitHub Pages 和 Releases 的仓库。",
        "install.copy": "网站位于 <code>docs/</code>。在 GitHub 中，从主分支启用 Pages 并选择 <code>/docs</code> 文件夹。",
